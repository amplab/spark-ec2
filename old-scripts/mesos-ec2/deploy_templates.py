...
# Deploy the configuration file templates in the mesos-ec2/templates directory
...
template_vars = {
  ...
  "cluster_url": open("/root/mesos-ec2/cluster-url").read(),
...
template_dir="/root/mesos-ec2/templates"
